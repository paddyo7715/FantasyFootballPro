...
Public Class Stock_TeamsDAO
    ...
    Public Function getAllStockTeams() As List(Of TeamMdl)
        ...
        Try
            ...
            Using rdr
                While (rdr.Read())
                    ID = rdr.GetInt32("ID")
                    City_Abr = rdr.GetString("City_Abr")
                    City = rdr.GetString("City")
                    nickname = rdr.GetString("nickname")
                    Stadium_Name = rdr.GetString("Stadium_Name")
                    Stadium_Location = rdr.GetString("Stadium_Location")
                    Stadium_Capacity = rdr.GetString("Stadium_Capacity")
                    Stadium_Img_Path = rdr.GetString("Stadium_Img_Path")
                    Helmet_img_path = rdr.GetString("Helmet_img_path")
                    Helmet_Color = rdr.GetString("Helmet_Color")
                    Helmet_Logo_Color = rdr.GetString("Helmet_Logo_Color")
                    Helmet_Facemask_Color = rdr.GetString("Helmet_Facemask_Color")
                    Socks_Color = rdr.GetString("Socks_Color")
                    Cleats_Color = rdr.GetString("Cleats_Color")
                    Home_jersey_Color = rdr.GetString("Home_jersey_Color")
                    Home_Sleeve_Color = rdr.GetString("Home_Sleeve_Color")
                    Home_Jersey_Number_Color = rdr.GetString("Home_Jersey_Number_Color")
                    Home_Jersey_Number_Outline_Color = rdr.GetString("Home_Jersey_Number_Outline_Color")
                    Home_Jersey_Shoulder_Stripe = rdr.GetString("Home_Jersey_Shoulder_Stripe")
                    Home_Jersey_Sleeve_Stripe_Color_1 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_1")
                    Home_Jersey_Sleeve_Stripe_Color_2 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_2")
                    Home_Jersey_Sleeve_Stripe_Color_3 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_3")
                    Home_Jersey_Sleeve_Stripe_Color_4 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_4")
                    Home_Jersey_Sleeve_Stripe_Color_5 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_5")
                    Home_Jersey_Sleeve_Stripe_Color_6 = rdr.GetString("Home_Jersey_Sleeve_Stripe_Color_6")
                    Home_Pants_Color = rdr.GetString("Home_Pants_Color")
                    Home_Pants_Stripe_Color_1 = rdr.GetString("Home_Pants_Stripe_Color_1")
                    Home_Pants_Stripe_Color_2 = rdr.GetString("Home_Pants_Stripe_Color_2")
                    Home_Pants_Stripe_Color_3 = rdr.GetString("Home_Pants_Stripe_Color_3")
                    Away_jersey_Color = rdr.GetString("Away_jersey_Color")
                    Away_Sleeve_Color = rdr.GetString("Away_Sleeve_Color")
                    Away_Jersey_Number_Color = rdr.GetString("Away_Jersey_Number_Color")
                    Away_Jersey_Number_Outline_Color = rdr.GetString("Away_Jersey_Number_Outline_Color")
                    Away_Jersey_Shoulder_Stripe = rdr.GetString("Away_Jersey_Shoulder_Stripe")
                    Away_Jersey_Sleeve_Stripe_Color_1 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_1")
                    Away_Jersey_Sleeve_Stripe_Color_2 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_2")
                    Away_Jersey_Sleeve_Stripe_Color_3 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_3")
                    Away_Jersey_Sleeve_Stripe_Color_4 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_4")
                    Away_Jersey_Sleeve_Stripe_Color_5 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_5")
                    Away_Jersey_Sleeve_Stripe_Color_6 = rdr.GetString("Away_Jersey_Sleeve_Stripe_Color_6")
                    Away_Pants_Color = rdr.GetString("Away_Pants_Color")
                    Away_Pants_Stripe_Color_1 = rdr.GetString("Away_Pants_Stripe_Color_1")
                    Away_Pants_Stripe_Color_2 = rdr.GetString("Away_Pants_Stripe_Color_2")
                    Away_Pants_Stripe_Color_3 = rdr.GetString("Away_Pants_Stripe_Color_3")
                    Stadium_Field_Type = rdr.GetString("Stadium_Field_Type")
                    Stadium_Field_Color = rdr.GetString("Stadium_Field_Color")
    ...
    Public Sub AddStockTeam(ByVal t As TeamMdl)
        ...
        Try
            SettingsConnection.Open()
            sSQL = "INSERT INTO TEAMS (City_Abr, City, Nickname, Helmet_img_path,
